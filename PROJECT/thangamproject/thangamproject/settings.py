"""
Django settings for thangamproject project.
...
ROOT_URLCONF = 'thangamproject.urls'
...
WSGI_APPLICATION = 'thangamproject.wsgi.application'
...
RAZORPAY_API_KEY= 'rzp_test_WEijDvCdBNHDrW'
RAZORPAY_API_SECRET = 'ONgWWaNhREJw9GE5FezPVV1O'